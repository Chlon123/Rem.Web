namespace Remont.Web.Repositories.Migrations
{
    ...
    public partial class PopulateUserDb : DbMigration
    {
        ...
        {
            Sql("insert into Accounts (AccountEmailAsLogin, AccountPassword, DateCreated, LastModified, ReturnUrl)" +
        ...
        {
            Sql("delete from Accounts where AccountEmailAsLogin = 'test1@gmail.com'");
            Sql("delete from Accounts where AccountEmailAsLogin = 'test2@gmail.com'");
